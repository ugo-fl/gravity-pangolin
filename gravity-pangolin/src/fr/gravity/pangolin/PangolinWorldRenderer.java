...
public class PangolinWorldRenderer {
	...
	// spriteBatch.draw(sprite.getTextureRegion(), sprite.getPosition().x +
	// sprite.getBoundingRectangle().x,
	// sprite.getPosition().y + sprite.getBoundingRectangle().y,
	// sprite.getBoundingRectangle().getWidth(), sprite
